        ...
        <nav class="navbar navbar-expand-md bg-dark navbar-dark">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav mr-auto">
                    ...
                    <a href="{{ route('page.products') }}" class="nav-item nav-link active">Productos</a>
                </div>
                            ...
                            <div class="product-item">
                                ...
                                <div class="product-image">
                                    <a href="product-detail.html">
                                        <img src="{{ asset('store/img/product-1.jpg') }}" alt="Product Image">
                                    </a>
                                ...
                                <div class="product-price">
                                    ...
                                    <a class="btn" href="{{ route('page.cart', $product->id) }}"><i class="fa fa-shopping-cart"></i>Comprar Ahora</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="sidebar-widget widget-slider">
                    <div class="sidebar-slider normal-slider">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset('store/img/product-10.jpg') }}" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset('store/img/product-9.jpg') }}" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="{{ asset('store/img/product-8.jpg') }}" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
...
<script src="store/https://code.jquery.com/jquery-3.4.1.min.js"></script>
