        ...
        <nav class="navbar navbar-expand-md bg-dark navbar-dark">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav mr-auto">
                    ...
                    <a href="{{ route('page.products') }}" class="nav-item nav-link">Productos</a>
                            ...
                            <tbody class="align-middle">
                                @foreach($cart as $item)
                                    <tr>
                                        <td>
                                            <div class="img">
                                                <a href="#"><img src="{{ asset('store/img/product-1.jpg') }}" alt="Image"></a>
                                                <p>{{ $item-> name }}</p>
                                            </div>
                                        </td>
                                            <td>${{ $item->price }}</td>
...
<script>
    function redireccionar(){
        window.location = "{{ route('page.chekout') }}"
    }
    function eliminar(id){
        var url = "{{ route('page.delete', 'temp') }}";
        url.replace('temp', id);
        window.location = url;
    }
</script>
