                    ...
                    <div class="col-md-3">
                        <nav class="navbar bg-light">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#"><i class="fa fa-shopping-bag"></i>Peliculas</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#"><i class="fa fa-plus-square"></i>Series</a>
                                </li>
                                <li class="nav-item">
                ...
                <div class="row align-items-center product-slider product-slider-4">
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                ...
                                <img src="{{ asset('store/img/product-6.jpg') }}" alt="Product Image">
                                </a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                <img src="{{ asset('store/img/product-7.jpg') }}" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
